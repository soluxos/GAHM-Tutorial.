...
This project has been edited and changed by Callum Harrod & Adam Worley
this is due to our initial project not working, so we decided to work
with Tom Dalling's code.

For this we managed to get multiple instance of a block working but could
not manage to get collision working. This is something we wish to continue
working on.
